...
volatile uint8_t FrameBuffer[N5110_PIXEL];
...
bool N5110_Init()
{
	...
	N5110_DDR |= _BV(N5110_DC) | _BV(N5110_RESET);
...
bool N5110_Update()
{
	...
	{
		if(!N5110_Write(FrameBuffer[i], N5110_DATA)) return false;
	}
